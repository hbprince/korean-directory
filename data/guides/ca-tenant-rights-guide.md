---
slug: "ca-tenant-rights-guide"
titleKo: "캘리포니아 세입자 권리 가이드"
titleEn: "California Tenant Rights Guide"
categorySlug: "real-estate"
summary: "CA 임대료 인상 제한, 퇴거 보호, 보증금 규정, 수리 요청 권리까지. 한인 세입자를 위한 권리 보호 완벽 가이드."
tags: ["세입자권리", "임대", "렌트", "보증금", "퇴거보호", "AB1482", "RSO", "샌프란시스코렌트", "오클랜드렌트", "산호세렌트", "한영용어"]
seasonStart: null
seasonEnd: null
sourceUrls: ["https://oag.ca.gov/consumers/general/landlord-tenant", "https://www.hud.gov/topics/rental_assistance", "https://dcba.lacounty.gov/renters-rights/"]
---
...
✅ 미국에 새로 정착하신 분은 [신규 이민자 정착 가이드](/guides/us-new-immigrant-settlement-guide)도 함께 참고하세요.

## CA 세입자 기본 권리 (AB 1482 Tenant Protection Act)

2020년 1월 시행된 **AB 1482**는 CA 전역의 세입자를 보호하는 핵심 법률입니다.
...
- ⚠️ 임대료 인상 통지가 서면이 아니거나 기한을 지키지 않으면 **무효**입니다

### LA시 RSO (Rent Stabilization Ordinance)
LA시에는 AB 1482보다 더 강한 **RSO**가 적용되는 건물이 있습니다.
...
### No-Fault (세입자 무귀책) 사유
6. 소유주 또는 직계 가족 입주 (Owner Move-in)
7. 건물 철거/대규모 리모델링
8. 정부 명령에 의한 퇴거
9. 임대 시장에서 영구 철수
...
⚠️ **입주 시 반드시 사진/동영상으로 상태를 기록**하세요. 퇴거 시 분쟁의 핵심 증거가 됩니다.

## 수리 요청 권리 (Warranty of Habitability)

집주인은 거주 적합한 상태를 유지할 **법적 의무**가 있습니다.
...
⚠️ 수리 요청에 대한 **보복 퇴거(Retaliatory Eviction)는 불법**입니다. 수리를 요청했다는 이유로 퇴거 통지를 받으면 법적으로 대응할 수 있습니다.
...
CA에는 LA 외에도 자체 렌트 컨트롤 조례를 운영하는 도시들이 있습니다. 해당 도시에 거주하면 AB 1482보다 더 강한 보호를 받을 수 있습니다.

### 샌프란시스코 (SF Rent Ordinance)
- **적용**: 1979년 6월 이전 건축 건물
- **연간 인상 한도**: SF Rent Board 매년 고시 (보통 0-2%)
- **관리 기관**: SF Rent Board (415) 252-4602
- **특이사항**: 수리 비용 pass-through 인상 가능

### 오클랜드 (Oakland Rent Adjustment Program)
- **적용**: 1983년 이전 건축 건물
- **연간 인상 한도**: CPI 기반 (보통 2-3%)
- **관리 기관**: Oakland RAP (510) 238-3721

### 산호세 (San Jose Apartment Rent Ordinance)
- **적용**: 1979년 9월 이전 건축 건물
- **연간 인상 한도**: 5%
- **관리 기관**: SJ Housing (408) 975-4480

✅ 자신의 도시에 별도 렌트 컨트롤이 있는지 확인하세요. 시 정부 웹사이트에서 "rent control" 또는 "rent stabilization"으로 검색하면 됩니다.
...
⚠️ 부동산 사기가 의심되면 [미국 한인 사기 예방 가이드](/guides/us-scam-prevention-guide)를 참고하세요.

한인맵에서 **한인 부동산 에이전트**와 **한인 변호사**를 찾아 임대 관련 상담을 받으세요.

## 한영 임대 용어 대조표

임대 관련 서류를 읽을 때 자주 등장하는 용어를 정리했습니다.

| 한국어 | English | 설명 |
|--------|---------|------|
| 임대인/집주인 | Landlord | 건물 소유자 |
| 임차인/세입자 | Tenant | 임대 거주자 |
| 보증금 | Security Deposit | 입주 시 예치금 |
| 월세/렌트 | Rent | 월간 임대료 |
| 임대 계약서 | Lease Agreement | 임대 조건 문서 |
| 퇴거 통지 | Eviction Notice | 퇴거 요구 서면 |
| 연체료 | Late Fee | 렌트 연체 시 추가 비용 |
| 정상 마모 | Normal Wear and Tear | 일반적 사용으로 인한 손상 |
| 전대/서브렛 | Subletting | 임차인이 다시 임대 |
| 소액 재판소 | Small Claims Court | $10,000 이하 민사 소송 |
| 건물 검사 | Code Enforcement | 건물 안전 기준 검사 |
| 이전 보상금 | Relocation Assistance | 퇴거 시 보상금 |

✅ 계약서나 통지서에서 모르는 영어 용어가 나오면 이 표를 참고하세요.
...
A: 아닙니다. CA 세입자 보호법은 이민 신분에 관계없이 모든 거주자에게 적용됩니다. 집주인이 이민 신분을 이유로 협박하거나 보복하는 것은 **불법**입니다 (AB 2819).
...
### Q: 한인 부동산에서 렌트하는 게 안전한가요?
A: 한인 부동산/집주인이라고 특별히 안전하거나 위험한 것은 아닙니다. 누구와 계약하든 반드시 서면 계약서를 작성하고, 보증금 영수증을 받고, 입주 시 상태를 사진으로 기록하세요. "한인끼리 믿을 수 있다"는 생각으로 구두 약속만 하면 분쟁 시 보호받기 어렵습니다. 법적 보호는 서면 기록에서 시작됩니다.

### Q: 불법체류자도 세입자 권리가 있나요?
A: 네, 있습니다. CA 세입자 보호법은 이민 신분에 관계없이 모든 거주자에게 동일하게 적용됩니다. 집주인이 이민 신분을 위협 도구로 사용하는 것은 AB 2819에 의해 불법입니다. 이민 신분 때문에 권리를 포기할 필요가 없습니다.

---

**면책조항**: 이 가이드는 일반적인 정보 제공 목적으로 작성되었으며, 법률 자문이 아닙니다. CA 주택법은 수시로 변경되며, LA시 등 지역별로 추가 규정이 있을 수 있습니다. 최신 정보는 [CA Attorney General](https://oag.ca.gov/consumers/general/landlord-tenant), [HUD](https://www.hud.gov/topics/rental_assistance)에서 확인하세요. 법적 분쟁이 있는 경우 반드시 변호사와 상담하시기 바랍니다.

**출처**: [CA Attorney General - Landlord/Tenant](https://oag.ca.gov/consumers/general/landlord-tenant), [HUD Rental Assistance](https://www.hud.gov/topics/rental_assistance), [LA County Renters' Rights](https://dcba.lacounty.gov/renters-rights/)
